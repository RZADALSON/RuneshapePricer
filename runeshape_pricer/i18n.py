...
_TR = {
    "en": {
        ...
        "currency_exalt": "Exalted Orbs (ex)",
        "currency_divine": "Divine Orbs (div)",
        "set_display": "Price display time (seconds):",
        "set_persist": "Keep prices until the Runeshape panel closes",
    ...
    "pl": {
        ...
        "set_currency": "Waluta cen:",
        "currency_exalt": "Exalty (ex)",
        "currency_divine": "Divine (div)",
        "set_display": "Czas wyświetlania cen (sekundy):",
        "set_persist": "Trzymaj ceny aż zamknie się panel Runeshape",
